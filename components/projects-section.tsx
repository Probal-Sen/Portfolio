...
const projects = [
  {
    id: 1,
    title: "UIT Football Tournament Manager",
    description: "A web application for managing football tournaments between different departments of the college.",
    image: "/Uit.png",
    technologies: ["React", "Node.js", "MongoDB", "Express.js","Socket.io","Next.js"],
    githubUrl: "https://github.com/Probal-Sen/uit-football-Tournament.git",
    liveUrl: "https://uit-football-tournament.vercel.app/",
  },
  {
    id: 2,
    ...
    technologies: ["Three.js", "TypeScript", "Tailwind", "React","Next.js","Framer Motion","Vercel"],
    githubUrl: "https://github.com/Adrish1512/Brain_Battle_3.0.git",
    liveUrl: "https://brain-battle-psi.vercel.app/",
  },
  {
    id: 3,
    title: "Solar Energy Predictor in India",
    description: "A machine learning model to predict solar energy generation in India based on weather data and historical patterns.",
    image: "/Solar_Energy.png",
    technologies: ["Python", "Pandas", "Scikit-learn", "Streamlit"],
    githubUrl: "https://github.com/Probal-Sen/Solar_energy_prediction_model.git",
  },
  {
    id: 4,
    ...
    image: "/Portfolio.jpg",
    technologies: ["Next.js", "Tailwind CSS", "Framer Motion", "TypeScript","Vercel","Lucide Icons"],
